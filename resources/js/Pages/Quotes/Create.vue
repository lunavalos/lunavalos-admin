...
// Calculate today's date for defaults
...
const addServiceToQuote = () => {
    ...
    if (service) {
        ...
        form.items.push({
            // Temporary ID for Vue loop keys (if needed, otherwise we use index)
                ...
                <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="md:col-span-1">
                                ...
                                <select 
                                    ...
                                    class="mt-1 block w-full border-gray-300 dark:border-zinc-800 dark:bg-zinc-950 dark:text-gray-100 focus:border-indigo-500 rounded-md text-sm"
                                >
                            ...
                            <div>
                                ...
                                <div class="mt-2 flex items-center space-x-4">
                                    ...
                                    <label class="inline-flex items-center cursor-pointer">
                                        ...
                                        <span class="ms-3 text-sm font-medium" :class="form.is_multiple_choice ? 'text-[#264ab3] dark:text-blue-400 font-bold' : 'text-gray-500 dark:text-zinc-400'">
                                    ...
                                    <template v-for="(item, index) in form.items" :key="index">
                                        ...
                                        <td class="p-2 align-top">
                                            <TextInput 
                                                ...
                                                class="w-full text-sm font-semibold !border-transparent !bg-transparent group-hover:!border-gray-300 dark:group-hover:!border-zinc-800 focus:!bg-white dark:focus:!bg-zinc-950 px-2 py-1" 
                                                required 
                                            />
                                        </td>
                                        <!-- Desc -->
                                        ...
                                        <!-- Utilidad -->
                                        <td class="p-2 align-top text-xs font-bold text-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="card bg-white dark:bg-zinc-900 shadow-sm sm:rounded-lg border border-gray-100 dark:border-zinc-800 p-6">
                            ...
                            <InputLabel for="notes" value="Notas Generales" class="font-bold text-gray-700 dark:text-gray-300 mb-2 block" />
                            <Wysiwyg
                                id="notes"
                                v-model="form.notes"
                        ...
                        <div class="card bg-gray-50 dark:bg-zinc-950/50 shadow-sm sm:rounded-lg border border-gray-200 dark:border-zinc-800 p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center text-gray-600 dark:text-zinc-400 bg-white dark:bg-zinc-900 p-3 rounded shadow-sm border border-purple-100 dark:border-purple-900/30">
                                ...
                                <div class="flex justify-between items-center text-gray-600 dark:text-zinc-400 bg-white dark:bg-zinc-900 p-3 rounded shadow-sm border border-green-100 dark:border-green-900/30">
