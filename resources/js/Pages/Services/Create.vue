                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div v-if="form.is_package" class="p-4 bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-md">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                    <label v-for="service in availableServices" :key="service.id" class="inline-flex items-center p-2 hover:bg-white dark:hover:bg-zinc-900 rounded transition-colors">
                                        <input type="checkbox" :value="service.id" v-model="form.services" class="rounded border-gray-300 dark:border-zinc-800 dark:bg-zinc-950 text-indigo-600 shadow-sm focus:ring-indigo-500">
