...
const submit = () => form.post(route('service-addons.store'));
</script>

<template>
    <Head title="Nuevo Addon" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-100">Nuevo Servicio Adicional</h2>
