...
const form = useForm({
    ...
    vault_credentials: [],
    notes: '',
    legal_name: props.quote_data?.legal_name || '',
    rfc: props.quote_data?.rfc || '',
    tax_regime: props.quote_data?.tax_regime || '',
    cfdi_use: props.quote_data?.cfdi_use || '',
    tax_zip_code: props.quote_data?.tax_zip_code || '',
    fiscal_address: props.quote_data?.fiscal_address || '',
    login_email: '',
    login_password: '',
        ...
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <Link
                    ...
                    class="btn bg-gray-500 dark:bg-zinc-800 hover:bg-gray-600 dark:hover:bg-zinc-600 text-white font-bold py-2 px-4 rounded shadow transition-colors"
                >
                    Cancelar
                </Link>
            </div>
        ...
        <div class="py-12">
            <div class="container mx-auto">
                <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <TextInput
                                    id="business_name"
                                    type="text"
                                    class="mt-1 block w-full border-gray-300 dark:border-zinc-800 focus:border-indigo-500 rounded-md dark:bg-zinc-950 dark:text-gray-100 placeholder-gray-400 dark:placeholder-zinc-500 transition-colors"
                            ...
                            <div>
                                <InputLabel for="contact_name" value="Nombre del Contacto" class="font-bold text-gray-700 dark:text-gray-300" />
                                <TextInput
                                    id="contact_name"
                                    type="text"
                            ...
                            <div>
                                <InputLabel for="city" value="Ciudad" class="font-bold text-gray-700 dark:text-gray-300" />
                                <TextInput
                                    id="city"
                                    type="text"
                                    class="mt-1 block w-full border-gray-300 focus:border-indigo-500 rounded-md"
                    ...
                    <div class="card bg-white dark:bg-zinc-900 shadow-sm sm:rounded-lg border border-gray-100 dark:border-zinc-800 p-6">
                        <div class="border-b border-gray-200 dark:border-zinc-800 pb-4 mb-6">
                            <h3 class="text-lg font-bold text-purple-700 dark:text-purple-400">3. Activos Técnicos y Accesos</h3>
                        </div>
                        ...
                        <div class="mt-6 p-4 bg-indigo-50 dark:bg-indigo-950/20 border border-indigo-100 dark:border-indigo-900 rounded-lg">
                            ...
                            <div v-else class="overflow-x-auto mt-4 border border-indigo-200 dark:border-indigo-900 rounded-lg shadow-sm">
                                <table class="min-w-full divide-y divide-indigo-200 dark:divide-indigo-900 bg-white dark:bg-zinc-950">
                                    <thead class="bg-indigo-50 dark:bg-indigo-950/40">
                                        <tr>
                                            <th scope="col" class="px-3 py-2.5 text-left text-xs font-bold text-indigo-700 dark:text-indigo-300 uppercase tracking-wider border-r border-indigo-100 dark:border-indigo-900 w-[20%]">Plataforma</th>
                                            <th scope="col" class="px-3 py-2.5 text-left text-xs font-bold text-indigo-700 dark:text-indigo-300 uppercase tracking-wider border-r border-indigo-100 dark:border-indigo-900 w-[20%]">Usuario</th>
                                            <th scope="col" class="px-3 py-2.5 text-left text-xs font-bold text-indigo-700 dark:text-indigo-300 uppercase tracking-wider border-r border-indigo-100 dark:border-indigo-900 w-[20%]">Contraseña</th>
                                            <th scope="col" class="px-3 py-2.5 text-left text-xs font-bold text-indigo-700 dark:text-indigo-300 uppercase tracking-wider border-r border-indigo-100 dark:border-indigo-900 w-[35%]">URL / Notas</th>
                                            <th scope="col" class="px-2 py-2.5 w-[5%] text-center text-xs font-medium text-gray-500 uppercase tracking-wider relative bg-indigo-50 dark:bg-indigo-950/40">
                                                <div v-if="!showCredentials" class="absolute inset-0 bg-indigo-50/80 dark:bg-zinc-950/80 backdrop-blur-[1px] flex items-center justify-center z-10" title="Desbloquea la bóveda para editar">🔒</div>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white dark:bg-zinc-950 divide-y divide-indigo-100 dark:divide-indigo-900 transition-all duration-300" :class="{'opacity-50 blur-[4px] pointer-events-none select-none': !showCredentials}">
                                        <tr v-for="(vault, index) in form.vault_credentials" :key="index" class="hover:bg-indigo-50/30 dark:hover:bg-indigo-900/20 transition-colors group">
                                            <td class="border-r border-indigo-100 dark:border-indigo-900 p-0">
                                                <input type="text" v-model="vault.service" class="w-full border-0 focus:ring-2 focus:ring-inset focus:ring-indigo-500 text-sm bg-transparent px-3 py-2.5 placeholder-gray-300 dark:placeholder-zinc-600 dark:text-gray-100 font-bold" placeholder="Ej: WordPress">
                                            </td>
                                            <td class="border-r border-indigo-100 dark:border-indigo-900 p-0">
                                                <input type="text" v-model="vault.user" class="w-full border-0 focus:ring-2 focus:ring-inset focus:ring-indigo-500 text-sm bg-transparent px-3 py-2.5 placeholder-gray-300 dark:placeholder-zinc-600 dark:text-gray-100" placeholder="Usuario">
                                            </td>
                                            <td class="border-r border-indigo-100 dark:border-indigo-900 p-0">
                                                <input type="text" v-model="vault.password" class="w-full border-0 focus:ring-2 focus:ring-inset focus:ring-indigo-500 text-sm bg-transparent px-3 py-2.5 font-mono placeholder-gray-300 dark:placeholder-zinc-600 dark:text-gray-100" placeholder="Contraseña">
                                            </td>
                                            <td class="border-r border-indigo-100 dark:border-indigo-900 p-0">
                                                <input type="text" v-model="vault.notes" class="w-full border-0 focus:ring-2 focus:ring-inset focus:ring-indigo-500 text-sm bg-transparent px-3 py-2.5 placeholder-gray-300 dark:placeholder-zinc-600 dark:text-gray-100" placeholder="URL o notas adicionales">
                                            </td>
                                            <td class="p-0 text-center whitespace-nowrap align-middle bg-indigo-50/20 dark:bg-indigo-950/20 group-hover:bg-red-50/30 dark:group-hover:bg-rose-900/30 transition-colors">
                                    ...
                                    <tbody class="bg-white dark:bg-zinc-950 divide-y divide-gray-200 dark:divide-zinc-800 transition-all duration-300" :class="{'opacity-50 blur-[4px] pointer-events-none select-none': !showCredentials}">
                                        <tr v-for="(account, index) in form.email_accounts" :key="index" class="hover:bg-blue-50/50 dark:hover:bg-blue-900/20 transition-colors group">
                                            <td class="border-r border-gray-200 dark:border-zinc-800 p-0 relative">
                                                <input type="email" v-model="account.email" class="w-full border-0 focus:ring-2 focus:ring-inset focus:ring-[#264ab3] text-sm bg-transparent px-3 py-2.5 placeholder-gray-300 dark:placeholder-zinc-600 dark:text-gray-100" placeholder="ejemplo@dominio.com" required>
                                            </td>
                                            <td class="border-r border-gray-200 dark:border-zinc-800 p-0 relative">
                                                <input type="text" v-model="account.password" class="w-full border-0 focus:ring-2 focus:ring-inset focus:ring-[#264ab3] text-sm bg-transparent px-3 py-2.5 font-mono placeholder-gray-300 dark:placeholder-zinc-600 dark:text-gray-100" placeholder="Contraseña">
                                            </td>
                                            <td class="border-r border-gray-200 dark:border-zinc-800 p-0 relative">
                                                <input type="text" v-model="account.username" class="w-full border-0 focus:ring-2 focus:ring-inset focus:ring-[#264ab3] text-sm bg-transparent px-3 py-2.5 placeholder-gray-300 dark:placeholder-zinc-600 dark:text-gray-100" placeholder="Usuario">
                                            </td>
                                            <td class="border-r border-gray-200 dark:border-zinc-800 p-0 relative">
                                                <input type="text" v-model="account.phone" class="w-full border-0 focus:ring-2 focus:ring-inset focus:ring-[#264ab3] text-sm bg-transparent px-3 py-2.5 placeholder-gray-300 dark:placeholder-zinc-600 dark:text-gray-100" placeholder="Teléfono">
                                            </td>
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
                                ...
                                <div>
                                    ...
                                    <TextInput id="imap_port" type="text" class="mt-1 block w-full border-gray-300 dark:border-zinc-800 dark:bg-zinc-950 dark:text-gray-100 focus:border-indigo-500 rounded-md" v-model="form.imap_port" placeholder="993" />
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
                                <div class="md:col-span-2">
                                    ...
                                    <TextInput id="smtp_host" type="text" class="mt-1 block w-full border-gray-300 dark:border-zinc-800 dark:bg-zinc-950 dark:text-gray-100 focus:border-indigo-500 rounded-md" v-model="form.smtp_host" placeholder="smtp.ejemplo.com" />
                                </div>
                                <div>
                                    <InputLabel for="smtp_port" value="Puerto SMTP" class="font-bold text-gray-700 dark:text-gray-300" />
                                    <TextInput id="smtp_port" type="text" class="mt-1 block w-full border-gray-300 dark:border-zinc-800 dark:bg-zinc-950 dark:text-gray-100 focus:border-indigo-500 rounded-md" v-model="form.smtp_port" placeholder="465" />
                                </div>
                                <div class="flex items-center pb-3">
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="checkbox" v-model="form.smtp_tls" class="rounded border-gray-300 dark:border-zinc-800 dark:bg-zinc-950 text-blue-600 shadow-sm focus:ring-blue-500 h-5 w-5">
                                        <span class="ml-2 text-sm font-bold text-gray-700 dark:text-gray-300">Usar SSL/TLS</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
                                <div class="md:col-span-2">
                                    ...
                                    <TextInput id="pop_host" type="text" class="mt-1 block w-full border-gray-300 dark:border-zinc-800 dark:bg-zinc-950 dark:text-gray-100 focus:border-indigo-500 rounded-md" v-model="form.pop_host" placeholder="pop.ejemplo.com" />
                                </div>
                                <div>
                                    <InputLabel for="pop_port" value="Puerto POP3" class="font-bold text-gray-700 dark:text-gray-300" />
                                    <TextInput id="pop_port" type="text" class="mt-1 block w-full border-gray-300 dark:border-zinc-800 dark:bg-zinc-950 dark:text-gray-100 focus:border-indigo-500 rounded-md" v-model="form.pop_port" placeholder="995" />
                                </div>
                                <div class="flex items-center pb-3">
                                    <label class="inline-flex items-center cursor-pointer">
                                        <input type="checkbox" v-model="form.pop_tls" class="rounded border-gray-300 dark:border-zinc-800 dark:bg-zinc-950 text-blue-600 shadow-sm focus:ring-blue-500 h-5 w-5">
                                        <span class="ml-2 text-sm font-bold text-gray-700 dark:text-gray-300">Usar SSL/TLS</span>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="card bg-white dark:bg-zinc-900 shadow-sm sm:rounded-lg border border-gray-100 dark:border-zinc-800 mb-6">
                        <div class="border-b border-gray-200 dark:border-zinc-800 p-6 pb-4 mb-6">
                            <h3 class="text-lg font-bold text-gray-700 dark:text-gray-200">5. Documentos y Archivos</h3>
                            <p class="text-sm text-gray-500 dark:text-zinc-400 mt-1">Adjunta la cotización, contrato y manuales del cliente.</p>
                        </div>
                    ...
                    <div class="card bg-white dark:bg-zinc-900 shadow-sm sm:rounded-lg border-l-4 border-blue-500 p-6">
                        <div class="border-b border-gray-200 dark:border-zinc-800 pb-4 mb-6">
                            <h3 class="text-lg font-bold text-blue-800 dark:text-blue-400">6. Accesos para el Portal de Cliente</h3>
                            <p class="text-sm text-gray-500 dark:text-zinc-400 mt-1">Si deseas que el cliente pueda entrar para ver sus tickets, crea su acceso aquí mismo.</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-0">
                            <div>
                                ...
                                <TextInput
                                    id="login_email"
                                    type="email"
                                    class="mt-1 block w-full border-gray-300 dark:border-zinc-800 focus:border-indigo-500 rounded-md bg-blue-50 dark:bg-zinc-950 dark:text-gray-100 placeholder-gray-400 dark:placeholder-zinc-500 transition-colors"
                    ...
                    <div class="card bg-white dark:bg-zinc-900 shadow-sm sm:rounded-lg border border-gray-100 dark:border-zinc-800 mb-6" v-if="$page.props.auth.user.is_admin">
                        ...
                        <div v-if="addingCost" class="p-6 bg-indigo-50 dark:bg-indigo-950/20 border-b border-indigo-100 dark:border-indigo-900">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                ...
                                <div>
                                    ...
                                    <select id="cost_freq" class="mt-1 block w-full border-gray-300 dark:border-zinc-800 focus:border-indigo-500 rounded-md shadow-sm dark:bg-zinc-950 dark:text-gray-100 transition-colors" v-model="tempCost.billing_frequency">
                                        <option value="monthly">Mensual</option>
                                        <option value="annual">Anual</option>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-left border-collapse">
                                ...
                                <tbody>
                                    <tr v-for="(cost, idx) in form.costs" :key="idx" class="border-b border-gray-100 dark:border-zinc-800/50 hover:bg-gray-50 dark:hover:bg-zinc-800/30 transition-colors">
                        ...
                        <div class="bg-gray-50 dark:bg-zinc-950/50 p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 rounded-b-lg border-t border-gray-200 dark:border-zinc-800">
                            ...
                            <div>
                                ...
                                <div class="text-sm flex justify-between mb-1">
                                    ...
                                    <span class="font-bold text-gray-800 dark:text-gray-200">{{ formatCurrency(form.initial_price) }}</span>
                                </div>
                                <div class="text-sm flex justify-between">
                                    <span class="text-gray-600 dark:text-zinc-400">Renovación:</span>
                                    <span class="font-bold text-green-700 dark:text-emerald-400">{{ formatCurrency(form.renewal_amount) }}</span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="text-sm flex justify-between mb-1">
                                    <span class="text-gray-600 dark:text-zinc-400">Únicos:</span>
                            ...
                            <div class="bg-white dark:bg-zinc-900 p-4 rounded-md shadow-sm border border-gray-100 dark:border-zinc-800 flex flex-col justify-center">
                                <h4 class="text-xs font-bold uppercase text-gray-500 dark:text-zinc-500 tracking-wider">Margen Inicial Aproximado (Utilidad)</h4>
                                <div class="mt-2 text-xl font-black" :class="(form.initial_price - totalUniqueCosts) > 0 ? 'text-green-600 dark:text-emerald-400' : ((form.initial_price - totalUniqueCosts) === 0 ? 'text-gray-600 dark:text-zinc-400' : 'text-red-600 dark:text-rose-400')">
                                    {{ formatCurrency(form.initial_price - totalUniqueCosts) }}
                                </div>
                                <div class="text-xs text-gray-400 dark:text-zinc-500 mt-1">Calculado: Cobro Inicial menos Costos Únicos.</div>
                            </div>
                        </div>
                    </div>
